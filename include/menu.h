...
#define MENU_BUY3_PAGE                  (4 * MENU_PAGE_SIZE)
#define MENU_UPGRADE_DRILL_PAGE         (5 * MENU_PAGE_SIZE)
#define MENU_HIRE_PAGE                  (6 * MENU_PAGE_SIZE)
#define MENU_OPTIONS_PAGE               (7 * MENU_PAGE_SIZE)
...
#define MENU_BUY2_OPT_CHARM            (MENU_BUY2_PAGE + 2)
...
#define MENU_HIRE_OPT_DUMPER            (MENU_HIRE_PAGE + 1)
#define MENU_HIRE_OPT_ACCOUNTANT        (MENU_HIRE_PAGE + 2)
#define MENU_HIRE_OPT_MANAGER           (MENU_HIRE_PAGE + 3)
...
const char MENU_SELL_CARGO_LABEL[] PROGMEM =    "Sell Inv";
...
const char MENU_DRILL_LABEL[] PROGMEM =         "The Drill";
const char MENU_CALCULATOR_LABEL[] PROGMEM =    "Calculator";
const char MENU_CHARM_LABEL[] PROGMEM =         "Charm";
...
const char MENU_HIRE_INFO[] PROGMEM =                 "Hire men\nto help\nout";
