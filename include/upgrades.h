...
#define UP_PICK_NUM_UPGRADES 8
const unsigned long UP_PICK_COST[] PROGMEM = {
  0, 
  200,601,1803,5415,16261,48828,146622
};
...
const unsigned long UP_DRILL_COST[] PROGMEM = {
  0, 
  50000,125000,312500,781250,1953125,4882813,12207031,30517578,76293945,190734863
};
...
const unsigned long UP_CONVEYOR_BELT_VALUE[] PROGMEM = {
  ...
  2,3,6,10,19,34,61,110,198,357,643,1157,2082,3748,6747,12144,21859,39346,70824
};
...
const unsigned long UP_ACCOUNTANT_VALUE[] PROGMEM = {
  0,
  16,40,100,250,625,1563,3906,9766,24414,61035
};
...
1000,3200,10240,32768,104858,335544,1073742,3435974,10995116,35184372 };
const unsigned long UP_DUMPER_VALUE[] PROGMEM = {UP_DUMPER_INITIAL_VALUE, 
50,90,162,292,525,945,1701,3061,5510,9918 };
